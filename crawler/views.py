...
@api_view(['GET'])
def year_month_2018(request, int):
	url = f'{homepage + querystring_2019}'
	if request.method == 'GET':
		r = requests.get(url, verify=False).text
...
@api_view(['GET'])
def year_month_2019(request, int):
	url = f'{homepage + querystring_2019}'
	if request.method == 'GET':
		r = requests.get(url, verify=False).text
...
@api_view(['GET'])
def year_month_2020(request,int):
	url = f'{homepage + querystring_2019}'
	if request.method == 'GET':
		r = requests.get(url, verify=False).text
...
@api_view(['GET'])
def year_month_daily2018(request,int,day):
	url = f'{homepage + querystring_2019}'
	if request.method == 'GET':
		r = requests.get(url, verify=False).text
...
@api_view(['GET'])
def year_month_daily2019(request,int,day):
	url = f'{homepage + querystring_2019}'
	if request.method == 'GET':
		r = requests.get(url, verify=False).text
...
@api_view(['GET'])
def year_month_daily2020(request,int,day):
	url = f'{homepage + querystring_2019}'
	if request.method == 'GET':
		r = requests.get(url, verify=False).text
